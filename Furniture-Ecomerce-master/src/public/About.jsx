  ...
  return (
    <section className="poppins-regular">
      ...
      <div className="h-72 flex justify-center flex-col items-center pageTopBg">
        ...
        <p ><span className='font-semibold'>Home {<RightOutlined className='icon' />}</span>  About</p>
      </div>
        ...
        <div className="mb-12 text-center container mx-auto px-4 md:px-0">
          <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <img src={imageSofa} alt="Sofa" className=" rounded-xl w-full h-full object-cover"/>
              </div>
            </div>
    ...
    <p className="text-gray-600 mt-2 text-sm md:text-base">
      ...
      and unique, Furniro has a wide range of styles to complement your home.
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <img src={imageTable} alt="Dining Table" className="rounded-xl w-full h-full object-cover"/>
              </div>
            </div>
          </div>
        </div>
