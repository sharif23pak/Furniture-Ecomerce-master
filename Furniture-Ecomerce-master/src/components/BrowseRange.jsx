...
import livingRoomimg from '../assets/Image-living room.png'
import dinning from '../assets/Mask Group.png'
                ...
                <div className="flex flex-wrap justify-center -m-4">
                    <div className="py-2 lg:w-1/3 md:w-1/3">
                        <div className="h-full bg-opacity-75 px-8 pt-0 pb-0 rounded-lg overflow-hidden text-center relative">
                                ...
                                <img src={ dinning } alt="Living room picture" />
                    ...
                    <div className="py-2 lg:w-1/3 md:w-1/3">
                        <div className="h-full bg-opacity-75 px-8 pt-0 pb-0 rounded-lg overflow-hidden text-center relative">
                                ...
                                <img src={ livingRoomimg } alt="Living room picture" />
                    ...
                    <div className="py-2 lg:w-1/3 md:w-1/3">
                        <div className="h-full bg-opacity-75 px-8 pt-0 pb-0 rounded-lg overflow-hidden text-center relative">
                                ...
                                <img src={ bedRoom } alt="Living room picture" />
